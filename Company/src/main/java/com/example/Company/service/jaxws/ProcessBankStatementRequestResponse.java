...
@XmlRootElement(name = "processBankStatementRequestResponse", namespace = "http://service.Bank.example.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "processBankStatementRequestResponse", namespace = "http://service.Bank.example.com/")
