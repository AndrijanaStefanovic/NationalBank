...
@XmlRootElement(name = "processBankStatementRequest", namespace = "http://service.example.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "processBankStatementRequest", namespace = "http://service.example.com/")
