...
@XmlType(name = "T_bankData", namespace = "http://service.example.com/mt910", propOrder = {
    "swift",
    "accountNumber"
})
public class TBankData {

    @XmlElement(name = "SWIFT", namespace = "http://service.example.com/mt910", required = true)
